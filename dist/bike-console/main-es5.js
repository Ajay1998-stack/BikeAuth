(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routingComponents = [_map_map_component__WEBPACK_IMPORTED_MODULE_7__["MapComponent"], _map_navigation_map_navigation_component__WEBPACK_IMPORTED_MODULE_6__["MapNavigationComponent"], _map_stations_map_stations_component__WEBPACK_IMPORTED_MODULE_5__["MapStationsComponent"],
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthenticationService = /** @class */ (function () {
                ...
                AuthenticationService.prototype.authenticate = function (username, password) {
                    return this.httpClient.post('http://localhost:8082/authenticate', { username: username, password: password }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (userData) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BikeFormComponent = /** @class */ (function () {
                function BikeFormComponent(router) {
                    this.router = router;
                }
                BikeFormComponent.prototype.ngOnInit = function () {
                };
                BikeFormComponent.prototype.bikeLogin = function () {
                    this.router.navigate(['/user-form']);
                };
                return BikeFormComponent;
            }());
            BikeFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MapNavigationComponent = /** @class */ (function () {
                function MapNavigationComponent(routeapiservice, zone, route, tripservice, router) {
                ...
                MapNavigationComponent.prototype.ngOnInit = function () {
                    ...
                    console.log();
                    var that = this;
                    var battery_navigator;
                    battery_navigator = this.getWindow().navigator.getBattery();
                    battery_navigator.then(function (battery) {
                    ...
                    var map = new mapbox_gl__WEBPACK_IMPORTED_MODULE_6__["Map"]({
                        container: 'map',
                    ...
                    this.routeapiservice.getGeoJsonLatLOng(this.coordinates).subscribe(function (data2) {
                        _this.zone.run(function () {
                            _this.waypoints = data2;
                ...
                MapNavigationComponent.prototype.startTrip = function () {
                ...
                MapNavigationComponent.prototype.endTrip = function () {
                    var _this = this;
                    this.rideStarted = false;
                    ...
                    this.tripservice.getInvoice().subscribe(function (invoice) {
                        console.log(invoice);
                        _this.router.navigateByUrl("/invoice/" + JSON.stringify(invoice));
                    });
                    /////////////////////////////////
                    function makePayment(booking_id, fare, tripservice) {
                        ...
                        console.log(payment);
                        var invoice = new _invoice__WEBPACK_IMPORTED_MODULE_1__["Invoice"]();
                        invoice.fare = 100;
                        invoice.travelDistance = 15;
                        console.log(invoice);
                ...
                MapNavigationComponent.prototype.getWindow = function () {
                    return window;
                };
                return MapNavigationComponent;
            }());
            MapNavigationComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MapStationsComponent = /** @class */ (function () {
                function MapStationsComponent() {
                }
                MapStationsComponent.prototype.ngOnInit = function () {
                ...
                MapComponent.prototype.ngOnInit = function () {
                    ...
                    */
                    ...
                    geocoder.on('results', function (results) {
                        ...
                        _this.destCoordinateLat = results.features[0].center[1];
                        _this.destCoordinateLng = results.features[0].center[0];
                    ...
                    geoLocate.on('geolocate', function (Position) {
                        ...
                        _this.userCoordinateLat = Position.coords.latitude;
                        _this.userCoordinateLng = Position.coords.longitude;
                        var geoMarker = new mapbox_gl__WEBPACK_IMPORTED_MODULE_2__["Marker"]({
                            draggable: true,
                            color: "orange"
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RoutingComponent = /** @class */ (function () {
                function RoutingComponent(routingservice, route, router) {
                ...
                RoutingComponent.prototype.ngOnInit = function () {
                    ...
                    this.coordinates[0] = JSON.parse(this.route.snapshot.paramMap.get('coordinate1'));
                    this.coordinates[1] = JSON.parse(this.route.snapshot.paramMap.get('coordinate2'));
                    this.routingservice.getDistanceMatrix(this.coordinates[1]).subscribe(function (data) {
                        console.log("POST Request is successful ", data);
                        console.log(typeof (data["resourceSets"]));
                        _this.results = data["resourceSets"][0]["resources"][0]["results"];
                        // console.log(data["resourceSets"][0]["resources"][0]["results"][0]["travelDistance"]);
                        // console.log("Inside: " + this.results);
                        console.log("Inside subscribe!");
                        console.log(_this.results);
                        findNearestStations(_this.results);
                    });
                    ...
                    function findNearestStations(results) {
                        ...
                        results.map(function (e) {
                            that.routingservice.stations.map(function (i) {
                ...
                RoutingComponent.prototype.navigate = function (destLatitude, destLongitude) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var RoutingapiserviceService = /** @class */ (function () {
                function RoutingapiserviceService(httpclient) {
                    this.httpclient = httpclient;
                ...
                RoutingapiserviceService.prototype.getGeoJsonLatLOng = function (coordinates) {
                ...
                RoutingapiserviceService.prototype.getDistanceMatrix = function (userDestination) {
                ...
                return RoutingapiserviceService;
            }());
            RoutingapiserviceService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserFormComponent = /** @class */ (function () {
                function UserFormComponent(router, loginservice) {
                    this.router = router;
                ...
                UserFormComponent.prototype.userLogin = function () {
                    var _this = this;
